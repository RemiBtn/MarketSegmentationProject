...
def prepare_XY(X, Y, criteria_mins, criteria_maxs, L):
    X_bar = as_barycenters(X, criteria_mins, criteria_maxs, L)
    Y_bar = as_barycenters(Y, criteria_mins, criteria_maxs, L)
    diff = X_bar - Y_bar
